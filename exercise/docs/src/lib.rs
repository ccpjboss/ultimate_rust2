...
//! coloration. The thick shell contains the edible seeds and pulp. 
//! The name is most commonly used for cultivars of Cucurbita pepo, but 
//! some cultivars of Cucurbita maxima, C. argyrosperma, and C. moschata 
...
//! ![pumpkin_image](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
/// # Recepies
/// 
/// Recipies will be comming very soon.
pub struct Pumpkin {
    /// `roundness` is a percentage value
    pub roundness: f32,
