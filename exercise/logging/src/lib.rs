...
impl Frog {
    ...
    pub fn hop(&mut self) {
        ...
        if self.energy == 0 {
            ...
            warn!(target: "Frog::hop","Frog is going to sleep because it ran out of energy");
            self.sleep();
        }
    }
    pub fn sleep(&mut self) {
        if self.sleeping {
            ...
            error!(target: "Frog::sleep","The frog is already sleeping zzz");
        } else {
            self.sleeping = true;
        }
    }
...
impl Default for Frog {
    fn default() -> Self {
        ...
        trace!(target: "Frog::default", "A default Frog was generated {:?}", &frog);
        return frog;
    }
}
